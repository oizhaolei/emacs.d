...
;;
;; If you want to use them plainly, set `init-hydra-verbatim' to t
...
(setq init-hydra-verbatim t)

;;* Examples
;;** Example 1: text scale
(when (bound-and-true-p init-hydra-verbatim)
...
(when (bound-and-true-p init-hydra-verbatim)
  (defhydra hydra-splitter (global-map "C-c SPC m s")
    "splitter"
...
(when (bound-and-true-p init-hydra-verbatim)
  (defhydra hydra-next-error (global-map "C-c SPC e")
    "next-error"
    ("`" next-error "next")
...
(global-set-key (kbd "C-c SPC t") 'hydra-toggle/body)
...
(global-set-key (kbd "C-c SPC a") 'hydra-apropos/body)
...
;; Recommended binding:
(global-set-key (kbd "C-c SPC r") 'hydra-rectangle/body)
...
(global-set-key (kbd "C-c SPC d") 'hydra-dired/body)
